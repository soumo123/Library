            ...
            books.map((resp) => (
              <div className="col-lg-4 col-sm-6">
                <div className="book-box">
                  ...
                  <p className="book-status">Status : <span className={resp.issued === true ? "red" : "green"}>{resp.status}</span></p>

                  <button className="btn btn-link mt-2 mb-2" disabled={resp.issued === true ? true : false} onClick={(e) => borrowBooksRequest(resp.name, resp._id)}>Request to Borrow</button>
